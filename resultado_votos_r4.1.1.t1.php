...
<table width="100%" border="1" cellspacing="0" bordercolor="#000000">
  <tr> 
    <td colspan="46"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Semestre: 
      [<a href="resultado_votos_r4.1.1.t1.php?sem=1">1</a>] [<a href="resultado_votos_r4.1.1.t1.php?sem=2">2</a>] 
      [<a href="resultado_votos_r4.1.1.t1.php?sem=3">3</a>] [<a href="resultado_votos_r4.1.1.t1.php?sem=4">4</a>] 
      [<a href="resultado_votos_r4.1.1.t1.php?sem=5">5</a>] [<a href="resultado_votos_r4.1.1.t1.php?sem=6">6</a>] 
      [<a href="resultado_votos_r4.1.1.t1.php?sem=7">7</a>] [<a href="resultado_votos_r4.1.1.t1.php?sem=8">8</a>] 
      [<a href="resultado_votos_r4.1.1.t1.php?sem=9">9</a>] [<a href="resultado_votos_r4.1.1.t1.php?sem=10">10</a>] 
...
?>
    ...
    <td colspan="5" bgcolor="#6699FF"> <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
        ...
        / <? echo $rstemp2["disciplina"]; echo " - $idd[$zz]" ?> <br>[<a href="resultado_votos_r4.1.1.detalhe.php?sem=<? echo $sem;?>&id_disc=<? echo $idd[$zz];?>"> Detalhe...</a> ] </strong></font></div></td>
  </tr>
  <tr> 
    <td width="15"> 
