...
$campos="SHOW FIELDS FROM aluno_escolaridade";
...
<form action="consulta_par_res_escola.php" method="post" name="displayform" >
  ...
  <select name="igual" id="igual">
    ...
    <option value="LIKE">COME&Ccedil;ANDO COM</option>
  </select>
  <input name="valor_busca" type="text" id="valor_busca" size="30" />
  <select name="tipo" id="tipo">
    <option value="" selected="selected">EXATA</option>
    <option value="%">INEXATA</option>
  </select>
  <br />
