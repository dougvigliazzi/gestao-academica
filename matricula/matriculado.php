...
?>
&nbsp;
<? } else { ?><a href="excluir_exe.php?ra=<? echo $ra;?>&disciplina=<? echo $rstemp["disciplina"]; ?>&disc=<? echo $id;?>&sem=<? echo $sem; ?>&nome=<? echo $nome_s;?>"><img src="imagens/x.gif" width="19" height="19" border="0" title="Apagar" alt="Remover"></a><? } ?></td>
          <? }  
		$rstemp=null;
