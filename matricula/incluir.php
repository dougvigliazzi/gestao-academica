...
switch($mes){
case '1':$semestre=1;$ano_m=$ano;break;
case '2':$semestre=1;$ano_m=$ano;break;
case '3':$semestre=1;$ano_m=$ano;break;
case '6':$semestre=2;$ano_m=$ano;break;
case '7':$semestre=2;$ano_m=$ano;break;
case '8':$semestre=2;$ano_m=$ano;break;
case '11':$semestre=1;$ano_m=$ano+1;break;
case '12':$semestre=1;$ano_m=$ano+1;break;
}
...
//incuir registros
$incluir="insert into ra_disc(ra,id_doc_disc,creditos,semestre,ano,sem,data) values('$ra','$disc','$cred','$sem','$ano','$semestre','$hoje')";
