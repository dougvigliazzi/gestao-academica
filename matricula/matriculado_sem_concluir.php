      ...
      <div align="center">Disciplinas matriculadas para o [<font color="#0066CC"> 
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"></font></div>
            <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><? echo $rstemp["disciplina"]; ?></strong></font></td>
          <td width="5%"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b> 
              <? echo $rstemp["creditos"]; ?></b></font><br>
            </div></td>
          <td width="5%"><a href="excluir_exe.php?ra=<? echo $ra;?>&disciplina=<? echo $rstemp["disciplina"]; ?>&disc=<? echo $id;?>&sem=<? echo $sem;?>"><img src="imagens/x.gif" width="19" height="19" border="0" alt="Remover"></a></td>
          <? }  
		$rstemp=null;
    ...
    <td><table width="100%" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
        ...
        <tr> 
          ...
          <td> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b> 
            ...
            <div align="center"><a href="excluir_rer_exe.php?ra=<? echo $ra;?>&disciplina=<? echo $dsc; ?>&disc=<? echo $idr;?>&sem=<? echo $sem;?>"><img src="imagens/x.gif" width="19" height="19" border="0" alt="Remover"></a></div></td>
          <? }  
		$rs_rer=null;
...
<? if($totalreg>=3){?>
  <a href="finaliza.php?ra=<? echo $ra; ?>&sem=<? echo $sem; ?>&nome=<? echo $nome; ?>">Concluir</a> </strong></font> </div>
<? } ?>
</body>
</html>
