...
?>
<title>Resultado : Avaliação de Docentes : <? echo $sem;?>º Semestre <? echo $ano;?></title>
...
<table width=80% border="1" cellspacing="0" bordercolor="#000000">
  <tr> 
    <td colspan="46"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Semestre: 
      ...
      :::::<font color="#FF0000" size="3"><? echo " ".$sem."º Semestre "; echo $ano; echo " $sqltemp2";?></font></strong></font> 
    </td>
  </tr>
  <tr> 
<?
