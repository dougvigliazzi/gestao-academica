...
//seleciona respostas
$sqltemp="select * from perguntas inner join resposta on perguntas.id_pergunta = resposta.id_pergunta where resposta.semestre = '$semestre' and resposta.id_doc_disc ='$disc' and resposta.datahora LIKE '$ano' order by perguntas.id_pergunta";
$rstemp_query=mysql_query($sqltemp,$conexao);

//seleciona docentes
$sqltemp2="select * from doc_disc where semestre='$semestre' and id_doc_disc ='$disc'"; 
...
?>
    ...
    <td colspan="6" bgcolor="#6699FF" width="120"> <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
        <? $idd[$zz]=$rstemp2["id_doc_disc"];  echo $rstemp2["docente"]; ?>
        / <? echo $rstemp2["disciplina"]; echo " - $idd[$zz]" ?> </strong></font></div></td>
  </tr>
  <tr> 
    <td width="20"> <div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <? $k=0; echo $k; ?>
        <br>
        <img src="imagens/b0.jpg" width="15" height="15"> </font></strong></div></td>
    <td width="20" bgcolor="#FFFFCC"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <? $x=1; echo $x; ?>
        <br>
