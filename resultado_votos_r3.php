...
<table width="100%" border="1" cellspacing="0" bordercolor="#000000">
  <tr> 
    <td colspan="45"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Semestre: 
      ...
      [<a href="resultado_votos_r3.php?sem=7">7</a>] [<a href="resultado_votos_r3.php?sem=80">BioMar</a>] 
      [<a href="resultado_votos_r3.php?sem=9">9</a>] [<a href="resultado_votos_r3.php?sem=81">GerCo</a>] 
  ...
  <tr> 
    ...
    <td colspan="5" bgcolor="#6699FF"> <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
        <? $id_disc=$rstemp2["id_doc_disc"];  echo $rstemp2["docente"]; ?>
        / 
  ...
  <tr> 
    ...
    <? 	for($s=1;$s<=$contt;$s++){
 			for($ii=1;$ii<=5;$ii++){ 
	  			//seleciona respostas
				$sqltemp_r="select count(*) from resposta where resp$s='$ii' and id_pergunta=$r and id_doc_disc=$id_disc";
...
$sqlcount="select * from respostas where semestre = '$sem'";
